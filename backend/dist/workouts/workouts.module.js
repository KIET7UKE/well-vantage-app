...
const workout_plan_entity_1 = require("./entities/workout-plan.entity");
const workout_day_entity_1 = require("./entities/workout-day.entity");
...
exports.WorkoutsModule = WorkoutsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([workout_plan_entity_1.WorkoutPlan, workout_day_entity_1.WorkoutDay, exercise_entity_1.Exercise])],
